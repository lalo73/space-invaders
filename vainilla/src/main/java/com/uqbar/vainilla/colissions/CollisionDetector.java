...
public class CollisionDetector {
     ...
     *
     * @param cx      - Coordenada x de la esquina superior izquierda del c�rculo
     *                (centroX - radio)
     * @param cy      - Coordenada y de la esquina superior izquierda del c�rculo
     *                (centroY - radio)
     * @param cratio  - Radio del c�rculo
     * @param rx      - Coordenada x de la esquina superior izquierda del rect�ngulo
     * @param ry      - Coordenada y de la esquina superior izquierda del rect�ngulo
     * @param rwidth  - Ancho del rect�ngulo
     * @param rheight - Alto del rect�ngulo
    ...
    public boolean collidesRectAgainstRect(Rectangle rect, Rectangle rect1) {
        return collidesRectAgainstRect(rect.getX(), rect.getY(), (int) rect.getWidth(), (int) rect.getHeight(), rect1.getX(), rect1.getY(),
